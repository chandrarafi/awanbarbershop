...
CREATE TABLE `booking` (
  `kdbooking` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `idpelanggan` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `total` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `idkaryawan` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
('BK-20250625-0003','PLG0003','completed','Lunas',100000,'100000.00','KRY003','2025-06-26','2025-06-25 23:14:40','2025-06-26 03:50:03','2025-06-25 23:19:40'),
('BK-20250625-0004','PLG0003','completed','Lunas',50000,'50000.00','KRY002','2025-06-26','2025-06-25 23:15:13','2025-06-26 03:45:10','2025-06-25 23:20:13'),
('BK-20250625-0005','PLG0004','completed','Lunas',150000,'150000.00','KRY001','2025-06-26','2025-06-25 23:18:48','2025-06-25 23:19:26',NULL),
('BK-20250626-0001','PLG0002','completed','Lunas',50000,'50000.00','KRY002','2025-06-26','2025-06-26 03:51:03','2025-06-26 03:51:27',NULL),
('BK-20250626-0002','PLG0003','expired','Belum Bayar',0,'100000.00','KRY003','2025-06-26','2025-06-26 08:39:52','2025-06-26 08:44:52','2025-06-26 08:44:52');
...
CREATE TABLE `detail_booking` (
  `iddetail` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tgl` date NOT NULL,
  `kdbooking` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `kdpaket` char(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nama_paket` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `idkaryawan` char(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
('DTL-20250626-0001','2025-06-26','BK-20250626-0001','PKT001','Basic Haircut','Potong rambut dasar dengan styling sederhana',50000,'10:00:00','11:00:00','2','KRY002','2025-06-26 03:51:03','2025-06-26 03:51:03'),
('DTL-20250626-0002','2025-06-26','BK-20250626-0002','PKT002','Premium Package','Potong rambut, keramas, pijat kepala, dan styling',100000,'10:00:00','11:00:00','','KRY003','2025-06-26 08:39:52','2025-06-26 08:44:52');
...
CREATE TABLE `detail_pembayaran` (
  ...
  `metode` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'cash',
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'paid',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `karyawan` (
  `idkaryawan` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `namakaryawan` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
insert  into `karyawan`(`idkaryawan`,`namakaryawan`,`jenkel`,`alamat`,`nohp`,`status`,`created_at`,`updated_at`) values 
('KRY001','Budi Santoso','L','Jl. Mawar No. 10, Jakarta Selatan','081234567890','aktif',NULL,'2025-06-26 04:03:17'),
('KRY002','Jaya Saputra','L','Jl. Melati No. 15, Jakarta Pusat','082345678901','aktif',NULL,'2025-06-26 08:51:03'),
('KRY003','Ahmad Rizki','L','Jl. Anggrek No. 20, Jakarta Timur','083456789012','aktif',NULL,'2025-06-26 04:03:31');
...
CREATE TABLE `notifications` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'jenis notifikasi: booking_baru, pembayaran, dll',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `reference_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'kdbooking, idfaktur, atau ID lain yang terkait',
  `idpelanggan` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'ID pelanggan yang terkait dengan notifikasi',
...
(45,'booking_baru','Booking Baru','Booking baru oleh Alex Putra dengan kode BK-20250626-0002','BK-20250626-0002','PLG0003',0,'2025-06-26 08:39:52','2025-06-26 08:39:52');
...
CREATE TABLE `otp` (
  ...
  `type` enum('registration','reset_password') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'registration',
...
CREATE TABLE `paket` (
  `idpaket` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `namapaket` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
('PKT001','Basic Haircut','Potong rambut dasar dengan styling sederhana',50000.00,'1750901679_01da38e4f32d39cabf7d.jpg','2025-05-14 17:57:47','2025-06-26 08:34:39'),
('PKT002','Premium Package','Potong rambut, keramas, pijat kepala, dan styling',100000.00,'1750901704_4176aaf4e47f66a97bae.jpg','2025-05-14 17:57:47','2025-06-26 08:35:04'),
('PKT003','Complete Treatment','Potong rambut, keramas, facial, pijat kepala, dan styling premium',150000.00,'1750901739_28518f0a1abbf18610f2.jpg','2025-05-14 17:57:47','2025-06-26 08:35:39');
...
CREATE TABLE `pelanggan` (
  ...
  `idpelanggan` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `pembayaran` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `fakturbooking` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `total_bayar` double NOT NULL DEFAULT '0',
  `grandtotal` double NOT NULL DEFAULT '0',
  `metode` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'cash',
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'paid',
  `jenis` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Lunas',
...
(34,'BK-20250625-0003',100000,100000,'transfer','paid','Lunas','BK-20250625-0003_1750868097_03780d6a194a0fd08735.jpg','2025-06-25 23:14:57','2025-06-26 03:50:03'),
(35,'BK-20250625-0004',50000,50000,'transfer','paid','DP','BK-20250625-0004_1750868129_41c3ec0518a8a47a68a7.jpg','2025-06-25 23:15:29','2025-06-26 03:45:10'),
(36,'BK-20250625-0005',150000,150000,'cash','paid','Lunas',NULL,'2025-06-25 23:18:48','2025-06-25 23:19:26'),
(37,'BK-20250625-0004',25000,50000,'cash','paid','Pelunasan',NULL,'2025-06-26 03:45:10','2025-06-26 03:45:10'),
(38,'BK-20250625-0004',25000,50000,'cash','paid','Pelunasan',NULL,'2025-06-26 03:45:10','2025-06-26 03:45:10'),
(39,'BK-20250626-0001',25000,50000,'cash','paid','DP',NULL,'2025-06-26 03:51:03','2025-06-26 03:51:27'),
(40,'BK-20250626-0001',25000,50000,'cash','paid','Pelunasan',NULL,'2025-06-26 03:51:27','2025-06-26 03:51:27');
...
CREATE TABLE `pengeluaran` (
  `idpengeluaran` char(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tgl` date NOT NULL,
...
(1,'admin','admin@admin.com','$2y$10$q0diYPnm5cBnu664cMMd9ulmEgjW6hUZA2gILBEWA56OGygYVpW86','Administrator','admin','active','2025-06-26 08:45:24',NULL,'2025-06-19 09:29:55','2025-06-26 08:45:24',NULL),
...
(6,'alex','alexputra@pingaja.site','$2y$10$T4GNNm.7nzl9PvdrN.a7DOQfcHVZn/NaKZMyBvjknbej3X0/lK/Nu','Alex Putra','pelanggan','active','2025-06-26 08:38:30',NULL,'2025-06-25 23:00:56','2025-06-26 08:38:30',NULL),
