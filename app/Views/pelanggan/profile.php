...
<section class="pt-32 pb-16">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12" data-aos="fade-up">
            <h1 class="text-3xl font-bold gradient-text mb-2">Profil Saya</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1" data-aos="fade-right">
                <div class="bg-white rounded-2xl shadow-lg p-6 card-hover">
                    <div class="flex flex-col items-center text-center">
                        <div class="w-32 h-32 mb-4 rounded-full bg-gradient-to-br from-[#E74C3C] to-[#F1C40F] p-1">
                        ...
                        <h2 class="text-xl font-bold text-gray-800 mt-2" id="profile-name"><?= $pelanggan['nama_lengkap'] ?></h2>
                        <p class="text-sm text-gray-500 mb-2">ID: <?= isset($pelanggan['idpelanggan']) ? $pelanggan['idpelanggan'] : 'Belum tersedia' ?></p>
                        <p class="text-sm text-gray-500">Member sejak: <?= date('d F Y', strtotime($pelanggan['created_at'])) ?></p>

                        <div class="w-full mt-6 border-t border-gray-200 pt-4">
                            <a href="<?= base_url('customer/booking') ?>" class="w-full btn-primary px-4 py-3 rounded-lg inline-flex items-center justify-center transform hover:scale-105 transition-all duration-300 mb-3">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                                <span>Riwayat Booking</span>
                            </a>
                            <a href="<?= base_url('customer/change-password') ?>" class="w-full bg-gray-100 hover:bg-gray-200 px-4 py-3 rounded-lg inline-flex items-center justify-center transition-all duration-300">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="lg:col-span-2" data-aos="fade-left">
                <div class="bg-white rounded-2xl shadow-lg p-6 card-hover">
                    <h3 class="text-xl font-bold text-gray-800 mb-6 pb-4 border-b border-gray-200">Informasi Pribadi</h3>

                    <!-- Alert untuk success & error akan ditampilkan di sini -->
                    <div id="alert-success" class="p-4 mb-6 text-sm text-green-700 bg-green-100 rounded-lg hidden" role="alert">
                    ...
                    <div id="alert-error" class="p-4 mb-6 text-sm text-red-700 bg-red-100 rounded-lg hidden" role="alert">
                        <div class="flex">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                            </svg>
                            <div id="error-message-container">
                                <ul class="list-disc pl-5 space-y-1" id="error-messages">
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-2">
                                ...
                                <input type="text" id="nama_lengkap" name="nama_lengkap" value="<?= $pelanggan['nama_lengkap'] ?>" required
                                    class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#E74C3C] focus:border-transparent">
                            </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea id="alamat" name="alamat" rows="3"
                                    class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#E74C3C] focus:border-transparent"><?= isset($pelanggan['alamat']) ? $pelanggan['alamat'] : '' ?></textarea>
                            </div>
                        </div>

                        <div class="mt-8 flex justify-end">
                            <button type="submit" id="saveButton" class="btn-primary px-6 py-3 rounded-lg inline-flex items-center transform hover:scale-105 transition-all duration-300">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
